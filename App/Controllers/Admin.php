...
class Admin extends Administered
{
    ...
    /* ==================================================================
     * 1st Block
     * Admin Members Block - 1 Functions
     * ====================================================================
     * */
    ...
    public function listMembersAction(){
        ...
        View::renderBlade('admin.list_members');
    ...
    public function searchMembersAction(){
       ...
       /* $xpg = !isset($_SESSION['x_page'])?1:$_SESSION['x_page'];
        $xqu = !isset($_SESSION['x_query'])?'':$_SESSION['x_query'];
        $xty = !isset($_SESSION['x_type'])?'':$_SESSION['x_type'];*/
//
//        $xpg = $_SESSION['x_page'];
//        $xqu = $_SESSION['x_query'];
//        $xty = $_SESSION['x_type'];

        View::renderBlade('admin.search_members',['states'=>$states]);
//        View::renderBlade('admin.search_members',['states'=>$states,'xpg'=>$xpg, 'xqu'=>$xqu, 'xty'=>$xty]);
     ...
     * List all Users
     */
    public function searchPrabhariAction(){

        $states = State::fetchAll();

        View::renderBlade('admin.search_prabhari',['states'=>$states]);
